...
$pull_all=sqlsrv_query($db_connection,"SELECT * from liquidation.dbo.itemrequestformlog where bindedid='$transaction_id'");
$counter=1;
while($pull_all_all=sqlsrv_fetch_array($pull_all,SQLSRV_FETCH_ASSOC)){
		...
		echo '
			...
			<tr style="color:white;">
				...
				<td style="overflow-wrap: break-word;">'.$pull_all_all['description'].'</td>
