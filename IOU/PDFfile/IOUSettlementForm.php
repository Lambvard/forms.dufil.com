...
class babatunde extends FPDF{
	...
	function userdetails($db_connection){
		...
		$this->LN(10);
		$this->Cell(0,-186,$current_details_pick['staffamount']." ".$curren,0,0,"C");
		$this->LN(10);
		$this->setFont("Arial","B",11);
		$this->Cell(0,-186,$current_details_pick['staffamountword'],0,0,"C");
		$this->LN(10);
		...
		$this->setFont("Arial","B",12);
		$this->setTextColor(255,0,0);
		$this->Cell(0,-82,"Account Name:".$current_details_pick['userbankaccname'],0,0,"C");
		$this->LN(2);
		//$this->SetFillColor(0,0,20);
		$this->Cell(0,-76,"Bank Name:".$current_details_pick['userbankname'],0,0,"C");
		$this->LN(2);
		$this->Cell(0,-70,"Account Number:".$current_details_pick['userbankaccountnumber'],0,0,"C");
