...
<form method="POST" action="db/server.php">	
		...
		<div class="form-group">
			...
			<input type="hidden" name="enteredduration" class="form-control" placeholder="Duration" required id="enteredduration" readonly value="0days">
		</div>
		...
		<div>
			...
			<input type="hidden" name="enteredreliever1" class="form-control" placeholder="Relievers name" required id="enteredreliever1" readonly value="NILL">
		</div>


		<div>
			<label style="display: none;">Reliever(2) Names:</label>
			<input type="hidden" name="enteredreliever2" class="form-control" placeholder="Relievers name" required id="enteredreliever2" readonly value="NILL">
		</div>
