...
echo '<div class="row col-12">'.$type."  Usage Report from ".$start."  to".$end.'</div>';
...
header("Content-Disposition: attachment; filename=UsageReport.xls");
