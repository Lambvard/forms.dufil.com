  ...
  <button class="btn btn my-2 my-sm-0" type="submit" style="margin-top: 10px; margin-bottom: 10px; background-color: #e70917; color: white;" >Search</button>
			...
			<section class="container" style=" margin-top: 100px;">
				<div class="row m-auto">
					<label style="font-weight: bold; font-family:tahoma; font-size: 30px;color: #e70917;" >Welcome to Loan Application Form!</label>
				</div>
				<div class="row m-auto">
				...
				<div class="" id="alloptionpanel">
				
					<div class="form-group m-auto"><button class="btn btn-info" style="margin: 10px; width: 400px;" id="personal" >Personal Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-success" style="margin: 10px;  width: 400px;" id="car">Car Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-danger" style="margin: 10px; width: 400px;" id="houseing">Housing Upfront Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-primary" style="margin: 10px;  width: 400px;" id="land">Land and House Ownership Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-secondary" style="margin: 10px; width: 400px;" id="Motocycle">Motocycle Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-danger" style="margin: 10px;  width: 400px;" id="external">External Loan</button></div>
					<div class="form-group m-auto"><button class="btn btn-info" style="margin: 10px; width: 400px;" id="Cooperative">Cooperative Loan</button></div>
...
<!-- staff identification -->
		<div class="containerfirst" id="personalform" style="display:none;">
		<div class="row m-auto">
		<div class="col-sm-8 offset-sm-2" style=" margin-top: 20px;">
			...
			<label style="font-weight: bold; color:#1F85DE;">Selected Loan Option:</label>
			<input type="text" name="loanpick" class="form-control" style="font-weight:bold;" required id="pickloan">
...
<div align="center" class="col-sm-12"><label style="font-size: 30px; font-weight: bold; margin-top: 5px;">'.$loanidpick.' Application Form</label></div>
	...
	<div class="alert alert-primary"><label style="font-size:20px;font-weight:bold;">Your Information</label></div>
		...
		<div class="form-group">
			...
			<input type="text" name="loanamountwords" class="form-control" placeholder="Enter Amount needed in words"   required min="0" step="0.01">
		</div>
		';
		echo'
		<div class="form-group">
...
echo'
		...
		';
	}elseif ($pick_trans=="CAR" OR $pick_trans=="CAR") {
		echo '<div class="col-lg-6 offset-lg-3 alert alert-danger" align="center"><label style="font-size: 24px;" align="center">You are either refreshing you browser or have a pending page you have not signed out</label></div>
		<div class="col-lg-4 offset-lg-4 "><a href="index.php?loan=loadrecoredsaved"><button class="form-control btn btn-info">Navigate to where to logout the transaction</button></a></div>
