...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
					...
					$('#guarantor1staffid2motor').on('input', function(){
						var guarantor1staffid2motor=$('#guarantor1staffid2motor').val();
						if(guarantor1staffid2motor==""){
							alert("Enter a valid staff ID");
							...
							//alert(loanstaffid);
								$.ajax({
									...
									data:{
										staffconfirm2:1,
										guarantor1staffid2motor:guarantor1staffid2motor
									},
									dataType:'JSON',
									success: function(motor2){

										
											$('#guarantor1name2motor').val(motor2.fullname);
											$('#manguan1loaddept2motor').val(motor2.dept);
											$('#guarantor1location2motor').val(motor2.loc);
				...
				$('#carsavedetails').click(function(){
					...
					var guarantordateofjoining1=$('#dateguarantorcar1').val();
					var guarantordateofjoining2=$('#dateguarantorcar2').val();
					...
					var manlevelpos1motor=$('#manlevelpos1motor').val();
					var levelpicker=$('#levelpicker').val();
					var guarantor1staffid2motor=$('#guarantor1staffid2motor').val();
					var guarantor1name2motor=$('#guarantor1name2motor').val();
					var guarantor1location2motor=$('#guarantor1location2motor').val();
					var guarantor1dept2motor=$('#manguan1loaddept2motor').val();
					var carguaaddress2motor=$('#manguaaddress2motor').val();
					var manlevelpos2motor=$('#manlevelpos2motor').val();
										
					if(loanstaffid=="" || guarantor1staffid==""|| guarantor2staffid==""|| loanfullname==""|| loadlocation==""|| loaddept==""|| carposition==""|| caramount==""||annualsalary==""||monthlysalary==""|| homeaddress==""||datajoined==""||dateofbirth==""||nextofkin==""||nextaddress==""||nextofkinrel==""||doyouhave==""||purpose==""||carpayable==""|| caryear==""||guarantor1name==""||guarantor1location==""||guarantor1dept=="" || carguaaddress==""||guan2fullname==""||guan2location==""||guan2loaddept==""||carguaposition=="" || levelpicker=="" || guarantordateofjoining1=="" || manlevelpos1motor=="" /*|| guarantor1dept2motor=="" || carguaaddress2motor=="" || manlevelpos2motor=="" || guarantordateofjoining2=="" */){
						...
						if(loanstaffid==guarantor1staffid || loanstaffid==guarantor2staffid || guarantor1staffid==guarantor2staffid){
								...
								$.ajax({
									...
									data:{
										...
										guarantordateofjoining1:guarantordateofjoining1,
										manlevelpos1motor:manlevelpos1motor,


										guarantor1staffid2motor:guarantor1staffid2motor,
										guarantor1name2motor:guarantor1name2motor,
										guarantor1location2motor:guarantor1location2motor,
										guarantor1dept2motor:guarantor1dept2motor,
										carguaaddress2motor:carguaaddress2motor,
										manlevelpos2motor:manlevelpos2motor,
									...
									success: function(carsaverecord){
											...
											var lvr=carsaverecord.tracklevel;
...
<div align="center" class="col-sm-12"><label style="font-size: 30px; font-weight: bold; margin-top: 5px;"> Car /Motorcycle Loan Application Form</label></div>
	...
	<div class="form-group">
		...
		<div class="form-group">
			<label style="font-weight:bold;">Annual Basic Salary:</label>
			<input type="number" id="annualsalary" class="form-control" placeholder="Enter your Annual Basic Salary"   required min="0" step="0.01">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<select  id="levelpicker" class="form-control"    required>
		...
		<div class="form-group">
			...
			<input type="text" id="nextofkin" class="form-control" placeholder="Enter next of kin name"    required>
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Next of Kin Address:</label>
			<input type="text" id="nextaddress" class="form-control" placeholder="Enter next of kin address"   required>
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Next of Kin Relationship:</label>
			<input type="text" id="nextofkinrel" class="form-control" placeholder="Enter next of kin relationship"   required>
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Do you have a Car/Motorcycle?:</label>
		...
		<div class="form-group" style="display: none;" id="makegroup">
			...
			<input type="text" id="maker" class="form-control" placeholder="Enter your car/Motorcycle make"   required>
		</div>
		<div class="form-group" style="display: none;" id="carreggroup">
			<label style="font-weight:bold;">Car Registration Number:</label>
			<input type="text" id="carreg" class="form-control" placeholder="Enter your car/Motorcycle Registration Number"   required>
		</div>
		<div class="form-group" style="display: none;" id="Chassisgroup">
			<label style="font-weight:bold;">Chassis No:</label>
			<input type="text" id="Chassis" class="form-control" placeholder="Enter your car/ Motorcycle Chassis Number"   required>
		</div>
		<div class="form-group" style="display: none;" id="enginenogroup">
			<label style="font-weight:bold;">Engine No:</label>
			<input type="text" id="engineno" class="form-control" placeholder="Enter your car/Motorcycle Engine Number"   required>
		</div>
		<div class="form-group" style="display: none;" id="yearpurchasegroup">
			<label style="font-weight:bold;">Year of Purchase:</label>
			<input type="date" id="yearpurchase" class="form-control" placeholder="Enter your car/ Motorcycle year of purchase"   required>
		</div>
		<div class="form-group">
		...
		<div class="form-group" style="display:;" id="motorcylereggroup">
			<label style="font-weight:bold; color: red;">Check to add additional Guarantor:? <input type="checkbox" id="motorcy" style="font-size: 40px;"></label>
...
<div class="form-group">
	...
	<div class="form-group">
		...
		<label style="font-weight:bold;">Guarantor Department:</label>
			...
			<div class="form-group">
			<label style="font-weight:bold;">Guarantor Date of Joining Company:</label>
			<input type="date" id="dateguarantorcar1" class="form-control" placeholder="Enter the date you joined the company"   required min="0">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor 1 Position:</label>
			<input type="text" id="manlevelpos1motor" class="form-control" placeholder="Enter your guarantor Position"    required >
		</div>
		...
		<div class="form-group" >
			...
			<input type="text" id="guarantor1staffid2motor" class="form-control" placeholder="Enter your staff ID" required value="" >
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor 2 Fullname:</label>
			<input type="text" id="guarantor1name2motor" class="form-control" placeholder="Enter fullname" required value="" readonly>
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor 2 Location:</label>
			<input type="text" id="guarantor1location2motor" class="form-control" placeholder="Location"  required readonly value="">
		</div>
		<div class="form-group">
		<label style="font-weight:bold;">Guarantor 2 Dapartment:</label>
				<input type="text" id="manguan1loaddept2motor" class="form-control" placeholder="Staff Department"    required readonly value="">
			</div>

		<div class="form-group">
		<label style="font-weight:bold;">Guarantor 2 Date of Joining Company:</label>
		<input type="date" id="dateguarantorcar2" class="form-control" placeholder="Enter the date you joined the company"   required min="0">
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor 2 Address:</label>
			<input type="text" id="manguaaddress2motor" class="form-control" placeholder="Enter your guarantor address"    required >
		</div>
		
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor 2 Position:</label>
			<input type="text" id="manlevelpos2motor" class="form-control" placeholder="Enter your guarantor Position"    required >
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="form-group">
			<!--carloanpdf.php-->
			<form method="POST" target="_blank" action="carloanroute.php">	<input type="hidden" name="yourtransidlink" id="yourtransid"  class="form-control">
			<button id="downloadmy" name="downloadmy" class="form-control btn btn-info" style="display: none;">Download My Loan Application Form</button>
			<input type="hidden" name="carloanroute" id="carleveltracker">
