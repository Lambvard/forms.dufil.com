...
//SURULERE/2021-03-02/CarLoan-1
		...
		$this->Cell(0,0,"CAR LOAN/CAR REFURBISHING LOAN",0,0,"C");
		$this->LN(10);
...
commercial",0,0,"L");
		...
		*/
		...
		$this->Cell(0,7,$fullname_split[1]." ".$fullname_split[2],0,0,"C");
		$this->LN(7);
...
$this->LN(100);
 ...
 $this->setFont("Arial","B",10);
		...
		$this->LN(8);
    	$this->Cell(180,0,$currentloan_loc['guarantor1position'],0,0,"C");
    	$this->LN(); 
		...
		$this->LN(10);
		$this->Cell(200,0,$currentloan_loc['guarantor1dateofjoining'],0,0,"C");
		$this->LN(); 
		...
		$this->LN(8);
    	$this->Cell(180,0,$currentloan_loc['guarantor2position'],0,0,"C");
    	$this->LN(); 
		...
		$this->LN(10); 
		$this->Cell(200,0,$currentloan_loc['guarantor2dateofjoining'],0,0,"C");
		$this->LN(); 
