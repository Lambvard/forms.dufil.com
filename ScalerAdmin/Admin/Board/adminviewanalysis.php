...
echo '
	...
	<td><label>Shift:</label></td><td><select class="form-control" name="shiftbase">
...
<div><a href="downloadpdf.php" target="_blank"><button class="btn btn-danger" target="_blank">Download PDF</button></a></div>
	...
	if(isset($_POST['goodpullboy'])){
		...
		$_SESSION['todate']=$date4;
			...
			$sqlr="
				SELECT * From scaler.wetnoodlles where SuperID='$dfg' AND Shift='$shiftbase' AND Dater BETWEEN '$date3' AND '$date4' 
				UNION ALL
				SELECT * From scaler.drytriming where SuperID='$dfg' AND Shift='$shiftbase'  AND Dater BETWEEN '$date3' AND '$date4'
				UNION ALL
				SELECT * From scaler.brokendry where SuperID='$dfg' AND Shift='$shiftbase'  AND Dater BETWEEN '$date3' AND '$date4'
				UNION ALL
				SELECT * From scaler.Dough where SuperID='$dfg' AND Shift='$shiftbase'  AND Dater BETWEEN '$date3' AND '$date4'
				UNION ALL
				SELECT * From scaler.trimmingoil where SuperID='$dfg' AND Shift='$shiftbase'  AND Dater BETWEEN '$date3' AND '$date4' ORDER BY Shift
				 ";
