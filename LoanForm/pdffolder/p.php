...
class babatunde extends FPDF{
	...
	function formatdetails($db_connection){
		...
		$this->Cell(-200,5,$current_details_pick['fullname'],0,0,"C");
		$this->LN(8);
		$this->setFont("Arial","",10);
		...
		$this->Cell(0,0,$current_details_pick['guarantor1name'],0,0,"C");
		$this->LN(8);
		$this->setFont("Arial","",10);
		$this->Cell(0,5,"Guanrantor's Department:..................................................................................................................................................",0,0,"L");
		$this->Cell(0,0,$current_details_pick['guarantor1dept'],0,0,"R");
		$this->LN(8);
		$this->setFont("Arial","",10);
		...
		$this->Cell(-260,0,$current_details_pick['timeuse'],0,0,"C");
		$this->Cell(200,0,$current_details_pick['dateuse'],0,0,"R");
		$this->LN(8);
		$this->setFont("Arial","",10);
		...
		$this->LN(10);
		$this->setFont("Arial","",10);
		$this->Cell(0,0,"part and ".$currentloan_loc['companyname']."(DUFIL GROUP) of (hereinafter called the Company of the ",0,0,"L");
		$this->LN(10);
		$this->setFont("Arial","B",10);
		...
		$this->Cell(-100,0,$current_details_pick['dateuse'],0,0,"C");
		$this->LN(8);
		$this->setFont("Arial","",10);
		...
		$this->Cell(0,5,"___________________________",0,0,"C");
		$this->LN();
		$this->setFont("Arial","B",10);
