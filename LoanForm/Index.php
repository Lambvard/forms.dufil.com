...
session_start();
	if(isset($_GET['loan'])){
		...
		if($pick_trans=="loanuseridentified"){
...
<div align="center" class="col-sm-12"><label style="font-size: 30px; font-weight: bold; margin-top: 5px;">LOAN APPLICATION FORM</label></div>
	...
	<div class="alert alert-primary"><label style="font-size:20px;font-weight:bold;">Your Information</label></div>
		...
		<div class="form-group">
			<label style="font-weight:bold;">Type of Loan:</label>
			...
			';
				...
				while($loanoption_pick=sqlsrv_fetch_array($loanoption,SQLSRV_FETCH_ASSOC)){
					echo '<option>'.$loanoption_pick['loantype'].'</option>';
				}
...
<div class="alert alert-success"><label style="font-size:20px;font-weight:bold;">First Guarantor Information</label></div>
	<div class="form-group">
			<label style="font-weight:bold;">Guarantor One Fullname:</label>
		...
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor one Location:</label>
		...
		<div class="form-group">
		<label style="font-weight:bold;">Guarantor One Dapartment:</label>
		...
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor One Position:</label>
			<input type="text" name="guan1position" class="form-control" placeholder="Enter Position Held"    required >
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor One Employment Date:</label>
...
<div class="alert alert-info"><label style="font-size:20px;font-weight:bold;">Second Guarantor Information</label></div>
	<div class="form-group">
			<label style="font-weight:bold;">Guarantor Two Fullname:</label>
		...
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor Two Location:</label>
		...
		<div class="form-group">
		<label style="font-weight:bold;">Guarantor Two Dapartment:</label>
		...
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor Two Position:</label>
			<input type="text" name="guan2position" class="form-control" placeholder="Enter Position Held"    required >
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Guarantor Two Employment Date:</label>
