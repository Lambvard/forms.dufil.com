...
<div align="center" class="col-sm-12"><label style="font-size: 30px; font-weight: bold; margin-top: 5px;">Personal Loan Application Form</label></div>
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" id="loanamount" class="form-control" placeholder="Enter Amount Needed"   required min="0" step="0.01">
		</div>

		<div class="form-group">
			<label style="font-weight:bold;">Amount in words:</label>
			<input type="text" id="loanamountd" class="form-control" placeholder="Enter Amount Needed"   required min="0">
		</div>
...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="date" id="guan1empdate" class="form-control" placeholder="Enter Amount Needed"   required>
		</div>

		<div class="form-group">
			<label style="font-weight:bold;">Designation:</label>
			<input type="text" id="design" class="form-control" placeholder="State Reason for Loan..."   required>
		</div>
...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="date" id="guan2empdate" class="form-control" placeholder="Enter Amount Needed"   required>
		</div>
		<div class="form-group">
			<label style="font-weight:bold;">Phone Number:</label>
			<input type="input" id="witnesspnumber" class="form-control" placeholder="Enter your date of Employment"   required>
		</div>
	...
	<div class="form-group">
			<form method="POST" target="_blank" action="personalpdf.php">	<input type="hidden" name="lontransidlink" id="lontransid"  class="form-control">
