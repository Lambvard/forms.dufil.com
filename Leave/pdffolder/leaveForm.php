...
class babatunde extends FPDF{
	...
	function userdetails($db_connection){
		...
		$this->Cell(-180,-76,"Account Name:".$current_details_pick['userbankaccname'],0,0,"C");
		$this->LN(2);
		//$this->SetFillColor(0,0,20);
		$this->Cell(200,-70,"Bank Name:".$current_details_pick['userbankname'],0,0,"C");
		$this->LN(2);
		$this->Cell(200,-63,"Account Number:".$current_details_pick['userbankaccountnumber'],0,0,"C");
