...
session_start();
	...
	$con_user=sqlsrv_query($db_connection,"SELECT * FROM dbo.staffdetailscar where Staffid='$userid_usecar'");
...
<form action="db/server.php" method="POST">
	...
	<div class="col-sm-6 offset-sm-3" style="border-radius: 10px 10px 10px 10px; border:1px solid grey; box-shadow: unset; background-color: #F9F9FC; margin-bottom: 50px;">
		...
		<div class="form-group">
			...
			<input type="date" name="enteredperiodfromcar" class="form-control" placeholder="Enter Period to be spent" required min="'.$td.'">
		</div>
