<?php
include("../class/dbconnector.class.php");


$connect= new Connector;

$connect->choosenconnector;
...
if(isset($_POST['getuserstaffid'])){
		...
		$user_query=sqlsrv_query($db_connection,"SELECT * FROM dbo.staffdetails WHERE Staffid='$useridinputed'");
...
//echo $_SESSION['cuuser'];
	...
	//var_dump($user_query_confirm);
		...
		$save_user_details=sqlsrv_query($db_connection,"INSERT INTO dbo.staff_transactionallog (fullname,staffid,stafflocation,staffdept,paymentreason,staffamount,staffamountdigit,subdate,subtime,status,useraccountname,userbankname,useraccountnumber,serialnumber,mnth) VALUES('$username_s','$staffid_s','$staff_loction_s','$user_dept_s','$user_reason_s','$user_amount_s','$user_amount_digit_s','$submission_date','$submission_time','$temstatus','$useraccountname','$userbankname','$useraccountnumber','$newid','$mnt') ");
		//session_start();
