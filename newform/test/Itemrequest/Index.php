	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#buttongroup').click(function(){
				...
				if(stafffullname=="" || staffid=="" || Remarks==""){
...
<div class="container-fluid firstbox">
		<div class="" style=" border:0px solid white;">
			<div class="container col-6 ">
				...
				<div class="container liq"><b style="">ITEM REQUEST FORM</b></div>
			</div>
			<!--<i class="fas fa-ticket-alt" style="color: white; size: 60px;">YES</i>-->

			<section class="container col-6">
				<i class="welcomeinfo">ITEM REQUEST FORM</i><p>
	...
	<div class="input-group"   style="margin-top: 15px;" id="selectiongroupliqsuperproliq">
		...
		<div class="input-group"    style="margin-top: 15px;" id="selectiongroupliqtakenproliq">
			...
			<div class="input-group"    style="margin-top: 15px;" id="selectiongroupliqtakenproliq">
					...
					<input type="text" class="form-control" name="" placeholder="Purpose/Remarks" id="Remarks" min="0" >
				</div>
...
*/
		...
		<form method="POST" action="pdffolder/itemrequestform.php" target="_blank">
