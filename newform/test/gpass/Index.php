		...
		$(document).ready(function(){
			...
			alert("Please provide your Staff ID for me to proceed");
						...
						$.ajax({
							...
							success: function(checkuserdetails){
								...
								$('#vehiclenumber').attr('disabled',false);
								$('#WayBillnumber').attr('disabled',false);
			...
			$('#buttongroup').click(function(){
				...
				if(stafffullname=="" && staffid==""){
					alert("Please put value in the Customer Name and Driver Name");
				}else{
				...
				//alert(staffid);
					...
					$.ajax({
						url:'db/server.php',
						method:'POST',
						data:{saveindividualrecordgatepass:1,
							...
							success: function(checkuserdetails){
								alert("Congratulations!, I have successfully created your truck/account details, Kindly fill in each items");	
				...
				//	alert("You mean I should save you?");
					...
					var transactionallid=$('#keeptransactionid').val();
						...
						$.ajax({
							...
							url:'db/server.php',
							method:'POST',
							data:{saveindividualrecordgatepassone:1,
...
<div class="container-fluid firstbox">
		<div class="" style=" border:0px solid white;">
			<div class="container col-6 ">
				...
				<div class="container liq"><b style="">Product Gate Pass</b></div>
			</div>
			<!--<i class="fas fa-ticket-alt" style="color: white; size: 60px;">YES</i>-->

			<section class="container col-6">
				<i class="welcomeinfo">Gate Pass Portal</i><p>
		...
		<div class="input-group"    style="margin-top: 15px;" id="selectiongroupliqtakenproliq">
					...
					<input type="text" class="form-control" name="" placeholder="Customer Name" id="customername" min="0" >
				</div>
	...
	<div class="input-group"   style="margin-top: 15px;" id="selectiongroupliqsuperproliq">
					...
					<input type="text" class="form-control" name="" placeholder="Vehicle Number" id="vehiclenumber" min="0" required="required">
				</div>
		...
		<div class="input-group"    style="margin-top: 15px;" id="selectiongroupliqtakenproliq">
					...
					<input type="text" class="form-control" name="" placeholder="WayBill Number" id="WayBillnumber" min="0" >
				</div>
			<div class="input-group"    style="margin-top: 15px;" id="selectiongroupliqtakenproliq">
					<!--<i style="color:#f55e01;font-weight: bold;">Taken out by?</i>  id="takenpror" style="display: none;" -->
					<div class="input-group-prepend">
					...
					<input type="text" class="form-control" name="" placeholder="Invoice/TS Number" id="Invoice" min="0" >
				</div>
			...
			<div class="row" style="margin-bottom:10px; margin-top:10px;" id="firstlog"><div  class="col-6" style="margin:0px;"><input type="text" class="form-control" name="" placeholder="Type Item Description and Specification" id="des_1"></div>
			<!-- <div  class="col-6" style=""><input type="text" class="form-control" name="" placeholder="Ref" id="ref_1"></div>--><div  class="col-6" style=""><input type="number" class="form-control" name="" placeholder="Quantity" id="num_1" min="1"></div>
...
*/
		...
		<form method="POST" action="pdffolder/gatepdf.php" target="_blank">
