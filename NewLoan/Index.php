...
<!-- staff identification -->
		<div class="containerfirst" id="personalform" >
...
echo'
		...
		<div class="col-lg-4 offset-lg-4" style="margin-top: 40px;" align="center"><a href="pdffolder/personalloan.php" target="_blank"><button class="btn btn-info"><b style="font-size: 19px;">Download My Loan Application form (PDF)</b></button></a></div>
