...
<body>
	<section class="container col-6">
		<h1  class="container col-12" style="margin-top: 80px;">ITEM GATE PASS FORMS</h1>
		<div class="" style="margin: 60px; border: px solid grey;  width: 300px; height: 300px;">
